...
#define RTTI_DEFINITIONS_TEMPLATED(Type)                                                \
    template <>                                                                         \
    const Fiea::Engine::RTTI::IdType Type::_typeId =                                 \
        reinterpret_cast<Fiea::Engine::RTTI::IdType>(&Type::_typeId)

#include "FieaGameEngine/RTTI.inl"